...
class Solution {
    ...
    private void forEachKey(int index, String prefix, String[] words, Consumer<String> action) {
        ...
        forEachKey(index + 1, prefix + words[index], words, action);
        forEachKey(index + 1, prefix + "-", words, action);
    }
}